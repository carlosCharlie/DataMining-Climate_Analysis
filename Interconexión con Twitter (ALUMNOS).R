...
#
consumerKey <- "ROT1xGXjcei1SXMJSnjBGcqMM"
...
#         obtenido de la aplicación desarrollada en Twitter.
#
consumerSecret <- "PSHnD04IeiuPwuI4dq2ZTc34oJXInbRkWmITjGFfRh7MHG8cLA"
...
# Pruebas:
misTweets = homeTimeline(n=10)
misTweets
mencionesDeMisTweets = mentions(n=10)
mencionesDeMisTweets
retuiteosDeMisTweets = retweetsOfMe(n=10)
retuiteosDeMisTweets
